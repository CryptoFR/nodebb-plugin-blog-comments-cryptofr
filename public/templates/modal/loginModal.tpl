      ...
      <div class="modal-login-form">
        ...
        <form action="#" id="login-form" method="POST">
          <div class="email-input-wrapper">
            <img src="https://testforum.cryptofr.com/plugins/nodebb-plugin-blog-comments-cryptofr/icons/user.svg" alt="email" class="icon inactive">
            <img src="https://testforum.cryptofr.com/plugins/nodebb-plugin-blog-comments-cryptofr/icons/user-active.svg" alt="twitter login" class="icon active">
            <input class="modal-input" name="email" type="text" value="" placeholder="Email" />
          </div>
          <div class="password-input-wrapper">
            <img src="https://testforum.cryptofr.com/plugins/nodebb-plugin-blog-comments-cryptofr/icons/key.svg" alt="mot de passe" class="icon inactive">
