...
function gifBoxInit() {
  ...
  try {
    ...
    for (var _iterator3 = document.querySelectorAll('.special-action.gif i')[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      _loop2();
    }
  } catch (err) {
...
},{"process":"rH1J"}],"xsmJ":[function(require,module,exports) {
"use strict";
...
function checkImgProfile() {
  if (document.querySelector(".first-image img")) {
    if (document.querySelector(".first-image img").getAttribute("src") == "") (0, _jquery.default)(".first-image img.profile-image").remove();else (0, _jquery.default)(".first-image div.profile-image").remove();
  }
}
/**
 * Parses template
...
function commentOptions() {
  (0, _jquery.default)(document).click(function (e) {
    var container = (0, _jquery.default)(".menuButton");

    if (!container.is(e.target) && container.has(e.target).length === 0) {
      (0, _jquery.default)(".options-container").hide();
    }
  });
  (0, _jquery.default)(document).mouseover(function (e) {
    var container = (0, _jquery.default)("#nodebb-comments-list .topic-body");
...
},{"../../settings.js":"LXja","./../util.js":"VGLh","../login/modal.js":"kjEe","../login/social.js":"Ca7Q","../login/form.js":"QP4Q","./loadComments.js":"V8ra","./sortComments.js":"JONd","../api.js":"gYYA","./expandComments.js":"PCfX","../onload.js":"sutU","../addons/gifs.js":"XBBC","../addons/upload.js":"w7Fc","jquery":"eeO1"}],"V8ra":[function(require,module,exports) {
"use strict";
...
},{"../settings.js":"LXja","./util.js":"VGLh","./login/modal.js":"kjEe","./login/social.js":"Ca7Q","./login/form.js":"QP4Q","./comments/loadComments.js":"V8ra","./comments/sortComments.js":"JONd","./api.js":"gYYA","./comments/drawComments.js":"xsmJ"}],"epB2":[function(require,module,exports) {
"use strict";
