...
function reloadComments() {
  ...
  _settings.set.commentsURL(nodeBBURL + "/comments/get/" + (window.blogger || "default") + "/" + articleID + "/" + _settings.page + "/" + _settings.sorting); // XHR.open("GET",commentsURL,true);
  // XHR.withCredentials = true;
  // XHR.send();


  newFetch(_settings.commentsURL, "");
  (0, _drawComments.drawComments)(); // console.log(XHR);
